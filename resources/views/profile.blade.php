                        ...
                        <ul class="menu">
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    ...
                                    <li><a href="{{route('profile')}}" class="active">Member Profile</a></li>
                ...
                <div class="member-profile">
                    <div class="profile-item">
                        <div class="profile-cover">
                            <img src="{{url('images/profile/cover.jpg')}}" alt="cover-pic">
                        ...
                        <div class="profile-information">
                            <div class="profile-pic">
                                <img src="{{url('images/profile/Profile.jpg')}}" alt="DP">
                    ...
                    <div class="profile-item d-none">
                        <div class="lab-inner">
                            <div class="lab-thumb">
                                <a href="#"><img src="{{url('images/profile/Profile.jpg')}}" alt="profile"></a>
                            </div>
                                                                    ...
                                                                    <div class="post-author">
                                                                        <div class="post-author-inner">
                                                                            <div class="author-thumb">
                                                                                <img src="{{url('images/profile/dp.png')}}"
                                                                                    alt="img">
                                                                            </div>
                                                                ...
                                                                <div class="post-content">
                                                                    ...
                                                                    <div class="post-description">
                                                                        ...
                                                                        <div class="post-desc-img">
                                                                            <div class="row g-3">
                                                                                <div class="col-md-6">
                                                                                    <img src="{{url('images/profile/post-image/02.jpg')}}"
                                                                                        alt="img">
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <img src="{{url('images/profile/post-image/03.jpg')}}"
                                                                                        alt="img">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <div class="post-item mb-20">
                                                                ...
                                                                <div class="post-content">
                                                                    ...
                                                                    <div class="post-description">
                                                                        ...
                                                                        <div class="post-desc-img">
                                                                            <img src="{{url('images/profile/post-image/01.jpg')}}"
                                                                                alt="img">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row row-cols-3 row-cols-sm-auto g-3">
                                                                <div class="col">
                                                                    <div class="image-thumb">
                                                                        <a href="#">
                                                                            <img src="{{url('images/widget/01.jpg')}}"
                                                                                alt="img">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <div class="col">
                                                                    <div class="image-thumb">
                                                                        <a href="#">
                                                                            <img src="{{url('images/widget/02.jpg')}}"
                                                                                alt="img">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <div class="col">
                                                                    <div class="image-thumb">
                                                                        <a href="#">
                                                                            <img src="{{url('images/widget/03.jpg')}}"
                                                                                alt="img">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <div class="col">
                                                                    <div class="image-thumb">
                                                                        <a href="#">
                                                                            <img src="{{url('images/widget/04.jpg')}}"
                                                                                alt="img">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <div class="col">
                                                                    <div class="image-thumb">
                                                                        <a href="#">
                                                                            <img src="{{url('images/widget/05.jpg')}}"
                                                                                alt="img">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <div class="col">
                                                                    <div class="image-thumb">
                                                                        <a href="#">
                                                                            <img src="{{url('images/widget/06.jpg')}}"
                                                                                alt="img">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <div class="col">
                                                                    <div class="image-thumb">
                                                                        <a href="#">
                                                                            <img src="{{url('images/widget/07.jpg')}}"
                                                                                alt="img">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <div class="col">
                                                                    <div class="image-thumb">
                                                                        <a href="#">
                                                                            <img src="{{url('images/widget/08.jpg')}}"
                                                                                alt="img">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <div class="col">
                                                                    <div class="image-thumb">
                                                                        <a href="#">
                                                                            <img src="{{url('images/widget/09.jpg')}}"
                                                                                alt="img">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="group-item lab-item">
                                                                <div
                                                                    ...
                                                                    <div class="lab-content w-100">
                                                                        ...
                                                                        <div class="test"> <a href="{{route('profile')}}"
                                                                                class="lab-btn"><i
                                                ...
                                                <div class="row gy-4 gx-3 justify-content-center">
                                                    <div class=" col-lg-3 col-md-4 col-6">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                <div class="lab-thumb">
                                                                    <img src="{{url('images/member/01.jpg')}}"
                                                                        alt="member-img">
                                                                </div>
                                                                <div class="lab-content">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-6">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                <div class="lab-thumb">
                                                                    <img src="{{url('images/member/02.jpg')}}"
                                                                        alt="member-img">
                                                                </div>
                                                                <div class="lab-content">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-6">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                <div class="lab-thumb">
                                                                    <img src="{{url('images/member/03.jpg')}}"
                                                                        alt="member-img">
                                                                </div>
                                                                <div class="lab-content">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-6">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                <div class="lab-thumb">
                                                                    <img src="{{url('images/member/04.jpg')}}"
                                                                        alt="member-img">
                                                                </div>
                                                                <div class="lab-content">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-6">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                <div class="lab-thumb">
                                                                    <img src="{{url('images/member/05.jpg')}}"
                                                                        alt="member-img">
                                                                </div>
                                                                <div class="lab-content">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-6">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                <div class="lab-thumb">
                                                                    <img src="{{url('images/member/06.jpg')}}"
                                                                        alt="member-img">
                                                                </div>
                                                                <div class="lab-content">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-6">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                <div class="lab-thumb">
                                                                    <img src="{{url('images/member/07.jpg')}}"
                                                                        alt="member-img">
                                                                </div>
                                                                <div class="lab-content">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-6">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                <div class="lab-thumb">
                                                                    <img src="{{url('images/member/08.jpg')}}"
                                                                        alt="member-img">
                                                                </div>
                                                                <div class="lab-content">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-6">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                <div class="lab-thumb">
                                                                    <img src="{{url('images/member/09.jpg')}}"
                                                                        alt="member-img">
                                                                </div>
                                                                <div class="lab-content">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-6">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                <div class="lab-thumb">
                                                                    <img src="{{url('images/member/10.jpg')}}"
                                                                        alt="member-img">
                                                                </div>
                                                                <div class="lab-content">
                                                                    <h6><a href="#">Andrea Guido</a> </h6>
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-6">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                <div class="lab-thumb">
                                                                    <img src="{{url('images/member/11.jpg')}}"
                                                                        alt="member-img">
                                                                </div>
                                                                <div class="lab-content">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-6">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                <div class="lab-thumb">
                                                                    <img src="{{url('images/member/12.jpg')}}"
                                                                        alt="member-img">
                                                                </div>
                                                                <div class="lab-content">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-6">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                <div class="lab-thumb">
                                                                    <img src="{{url('images/member/13.jpg')}}"
                                                                        alt="member-img">
                                                                </div>
                                                                <div class="lab-content">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-6">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                <div class="lab-thumb">
                                                                    <img src="{{url('images/member/14.jpg')}}"
                                                                        alt="member-img">
                                                                </div>
                                                                <div class="lab-content">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-6">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                <div class="lab-thumb">
                                                                    <img src="{{url('images/member/15.jpg')}}"
                                                                        alt="member-img">
                                                                </div>
                                                                <div class="lab-content">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-6">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                <div class="lab-thumb">
                                                                    <img src="{{url('images/member/16.jpg')}}"
                                                                        alt="member-img">
                                                                </div>
                                                                <div class="lab-content">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-6">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                <div class="lab-thumb">
                                                                    <img src="{{url('images/member/17.jpg')}}"
                                                                        alt="member-img">
                                                                </div>
                                                                <div class="lab-content">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-6">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                <div class="lab-thumb">
                                                                    <img src="{{url('images/member/18.jpg')}}"
                                                                        alt="member-img">
                                                                </div>
                                                                <div class="lab-content">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-6">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                <div class="lab-thumb">
                                                                    <img src="{{url('images/member/19.jpg')}}"
                                                                        alt="member-img">
                                                                </div>
                                                                <div class="lab-content">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-6">
                                                        <div class="lab-item member-item style-1">
                                                            <div class="lab-inner">
                                                                <div class="lab-thumb">
                                                                    <img src="{{url('images/member/20.jpg')}}"
                                                                        alt="member-img">
                                                                </div>
                                                                <div class="lab-content">
                                                        ...
                                                        <div class="group-item lab-item style-1">
                                                            <div
                                                                ...
                                                                <div class="lab-thumb me-md-4 mb-4 mb-md-0">
                                                                    <img src="{{url('images/group/group-page/01.jpg')}}"
                                                                        alt="img">
                                                                </div>
                                                                <div class="lab-content">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="group-item lab-item style-1">
                                                            <div
                                                                class="lab-inner d-flex flex-wrap align-items-center p-4">
                                                                <div class="lab-thumb me-md-4 mb-4 mb-md-0">
                                                                    <img src="{{url('images/group/group-page/02.jpg')}}"
                                                                        alt="img">
                                                                </div>
                                                                <div class="lab-content">
                                                                    <h4>Active Group A2</h4>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="group-item lab-item style-1">
                                                            <div
                                                                class="lab-inner d-flex flex-wrap align-items-center p-4">
                                                                <div class="lab-thumb me-md-4 mb-4 mb-md-0">
                                                                    <img src="{{url('images/group/group-page/03.jpg')}}"
                                                                        alt="img">
                                                                </div>
                                                                <div class="lab-content">
                                                                    <h4>Active Group A2</h4>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="group-item lab-item style-1">
                                                            <div
                                                                class="lab-inner d-flex flex-wrap align-items-center p-4">
                                                                <div class="lab-thumb me-md-4 mb-4 mb-md-0">
                                                                    <img src="{{url('images/group/group-page/04.jpg')}}"
                                                                        alt="img">
                                                                </div>
                                                                <div class="lab-content">
                                                                    <h4>Active Group A2</h4>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="group-item lab-item style-1">
                                                            <div
                                                                class="lab-inner d-flex flex-wrap align-items-center p-4">
                                                                <div class="lab-thumb me-md-4 mb-4 mb-md-0">
                                                                    <img src="{{url('images/group/group-page/05.jpg')}}"
                                                                        alt="img">
                                                                </div>
                                                                <div class="lab-content">
                                                                    <h4>Active Group A2</h4>
                                ...
                                <div
                                    ...
                                    <div class="col">
                                        <div class="gallery-img">
                                            <img src="{{url('images/member/03.jpg')}}" alt="image" class="rounded">

                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="gallery-img">
                                            <img src="{{url('images/member/02.jpg')}}" alt="image" class="rounded">

                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="gallery-img">
                                            <img src="{{url('images/member/01.jpg')}}" alt="image" class="rounded">

                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="gallery-img">
                                            <img src="{{url('images/member/04.jpg')}}" alt="image" class="rounded">

                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="gallery-img">
                                            <img src="{{url('images/member/05.jpg')}}" alt="image" class="rounded">

                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="gallery-img">
                                            <img src="{{url('images/member/06.jpg')}}" alt="image" class="rounded">

                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="gallery-img">
                                            <img src="{{url('images/member/07.jpg')}}" alt="image" class="rounded">

                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="gallery-img">
                                            <img src="{{url('images/member/08.jpg')}}" alt="image" class="rounded">

                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="gallery-img">
                                            <img src="{{url('images/member/09.jpg')}}" alt="image" class="rounded">

                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="gallery-img">
                                            <img src="{{url('images/member/10.jpg')}}" alt="image" class="rounded">

                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="gallery-img">
                                            <img src="{{url('images/member/11.jpg')}}" alt="image" class="rounded">

                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="gallery-img">
                                            <img src="{{url('images/member/12.jpg')}}" alt="image" class="rounded">

                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="gallery-img">
                                            <img src="{{url('images/member/13.jpg')}}" alt="image" class="rounded">

                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="gallery-img">
                                            <img src="{{url('images/member/14.jpg')}}" alt="image" class="rounded">

                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="gallery-img">
                                            <img src="{{url('images/member/15.jpg')}}" alt="image" class="rounded">

                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="gallery-img">
                                            <img src="{{url('images/member/16.jpg')}}" alt="image" class="rounded">

                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="gallery-img">
                                            <img src="{{url('images/member/17.jpg')}}" alt="image" class="rounded">

                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="gallery-img">
                                            <img src="{{url('images/member/18.jpg')}}" alt="image" class="rounded">

                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="gallery-img">
                                            <img src="{{url('images/member/19.jpg')}}" alt="image" class="rounded">

                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="gallery-img">
                                            <img src="{{url('images/member/20.jpg')}}" alt="image" class="rounded">
